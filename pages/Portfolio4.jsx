        ...
        <div className='w-full h-screen lg:h-full'>
            ...
            <div className='max-w-[1024px] mx-auto grid md:grid-cols-5 gap-8 px-3 pt-8'>
                <div className=' col-span-3 text-justify'>
                    ...
                    <p>
                        in the process of making this web using the bootstrap framework, this web is also made user-friendly where the web display is full responsive.
                    </p>
                </div>
                <div className='col-span-4 md:col-span-2 shadow-xl shadow-gray-300 rounded-xl p-4'>
                    <div className='p-2'>
                        ...
                        <div className='grid grid-cols-3 md:grid-cols-1'>
                            ...
                            <p className='flex items-center text-gray-600 py-2 gap-4'><RiRadioButtonFill/> Bootsrap</p>
